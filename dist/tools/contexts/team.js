...
export function registerTeamTools(server, runtime) {
    ...
    const executeCreateMembership = async (input, extra) => {
        try {
    ...
    const executeCreateTeam = async (input, extra) => {
        try {
    ...
    const executeCreateTeamAttributeDefinition = async (input, extra) => {
        try {
    ...
    const executeDeleteMembership = async (input, extra) => {
        try {
    ...
    const executeDeleteTeam = async (input, extra) => {
        try {
    ...
    const executeDeleteTeamAttributeDefinition = async (input, extra) => {
        try {
    ...
    const executeListTeamAttributeDefinitions = async (input, extra) => {
        try {
    ...
    const executeListTeams = async (input, extra) => {
        try {
    ...
    const executeRetrieveTeam = async (input, extra) => {
        try {
    ...
    const executeRetrieveTeamAttributeDefinition = async (input, extra) => {
        try {
    ...
    const executeUpdateTeam = async (input, extra) => {
        try {
    ...
    const executeUpdateTeamAttributeDefinition = async (input, extra) => {
        try {
