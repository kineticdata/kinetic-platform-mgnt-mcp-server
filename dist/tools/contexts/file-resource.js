...
export function registerFileResourceTools(server, runtime) {
    ...
    const executeCreateFile = async (input, extra) => {
        try {
    ...
    const executeCreateFileResource = async (input, extra) => {
        try {
    ...
    const executeDeleteFile = async (input, extra) => {
        try {
    ...
    const executeDeleteFileResource = async (input, extra) => {
        try {
    ...
    const executeListFileResources = async (input, extra) => {
        try {
    ...
    const executeRetrieveFile = async (input, extra) => {
        try {
    ...
    const executeRetrieveFileResource = async (input, extra) => {
        try {
    ...
    const executeUpdateFileResources = async (input, extra) => {
        try {
