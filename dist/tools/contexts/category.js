...
export function registerCategoryTools(server, runtime) {
    ...
    const executeCreateCategorization = async (input, extra) => {
        try {
    ...
    const executeCreateCategory = async (input, extra) => {
        try {
    ...
    const executeDeleteCategorization = async (input, extra) => {
        try {
    ...
    const executeDeleteCategory = async (input, extra) => {
        try {
    ...
    const executeListCategories = async (input, extra) => {
        try {
    ...
    const executeListCategorizations = async (input, extra) => {
        try {
    ...
    const executeRetrieveCategorization = async (input, extra) => {
        try {
    ...
    const executeRetrieveCategory = async (input, extra) => {
        try {
    ...
    const executeUpdateCategorization = async (input, extra) => {
        try {
    ...
    const executeUpdateCategory = async (input, extra) => {
        try {
